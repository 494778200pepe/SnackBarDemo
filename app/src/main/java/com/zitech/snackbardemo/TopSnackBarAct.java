...
import com.zitech.snackbardemo.topsnackbar.TSnackbar;

/**
 * Created by pepe on 2016/9/12.
 */
public class TopSnackBarAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_top_snackbar);
        ...
        button_example_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView textView = (TextView) snackbarView.findViewById(com.zitech.snackbardemo.R.id.snackbar_text);
